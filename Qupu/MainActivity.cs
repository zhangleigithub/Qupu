...
namespace Qupu
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            {
                // Plug in my adapter:
                using (StreamReader sr = new StreamReader(Assets.Open("qupu.json")))
                {
                    this.qupus = Newtonsoft.Json.JsonConvert.DeserializeObject<QupuModel[]>(sr.ReadToEnd()).ToList();
                }
